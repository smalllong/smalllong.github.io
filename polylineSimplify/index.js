...
map.plugin("AMap.DragRoute", function () {
    route = new AMap.DragRoute(map, path, AMap.DrivingPolicy.LEAST_FEE, { showTraffic: false }); //构造拖拽导航类
...
function simplify() {
    ...
    polyline.setMap();
    var start = Date.now(), p = simplifyPolyline(route.getRoute());
    route.destroy();
    console.log(p);
    ...
    polyline.setPath(p);
    polyline.setMap(map);
	function setCount() {count.innerHTML = p.length;}
